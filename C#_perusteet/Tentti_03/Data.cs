...
namespace Tentti_03
{
    //Valmiiksi annettu koodi - sisältää ja tuottaa datan ohjelman tarpeisiin
    public static class Data
    {
        ...
        {
            string[] names =
                {"Antti","Aulis","Aulikki","Bertta","Eemeli","Eetu","Esko","Hannele",
                "Hannu","Heikki","Harri","Heli","Helena","Iines","Ilkka","Ilmari",
                "Ida", "Irene","Jaakko","Jari","Juha","Jukka","Jaana","Juhani",
                "Kalevi","Kikka","Kaarina","Kalle","Kauko","Kimmo", "Liisa","Leevi",
                "Lilli","Lumi","Martti","Matti","Mauno","Melina","Miisa","Merja",
                "Marja","Niilo","Nina","Niina","Ninna","Oona","Olavi","Oskari",
                "Pentti","Panu","Pertti","Petri","Paula","Pauliina","Pirkko",
                "Raimo", "Rauli", "Riikka", "Ritva", "Raili","Sara", "Saara",
                "Sauli","Sakari","Seppo","Taina","Tiina","Tuuli","Tuula","Timo",
                "Tino","Tomas","Tuomas","Unto","Uolevi","Veikko","Veera","Vesa",
                "Väinö","Yrjö"};
        ...
        private static string GenerateLastName()
        {
            string[] part1 = { "Aalto", "Joki", "Meri", "Järvi", "Virta", "Vuori", "Lehto",
                             "Leppi", "Koivu", "Salo", "Niemi", "Lahti", "Laiho", "Haka",
                             "Ala", "Ylä", "Väli", "Keski"};
